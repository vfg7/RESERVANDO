...
import com.project.hotel.chain.HotelChainApplication;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage(HotelChainApplication.class.getPackage().getName()))
	...
	private ApiInfo getApiInfo() {
		return new ApiInfoBuilder()
				.title("Hotel Chain")
				.description("Hotel Chain Rest Server")
